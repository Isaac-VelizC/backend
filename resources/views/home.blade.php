        ...
        <div class="row">
                ...
                <div class="card p-xl-4">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-color" data-value="sidebar-white">
                            <span class=""> Predeterminado </span>
                        </div>
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                            <span class="mt-2">Redondeado por un lado</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <span class="mt-2">Redondeado todo</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Píldora de un lado</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
                            <span class="mt-2">Píldora para todo</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mt-4 mb-3">Personalizador de color</h5>
                ...
                <hr class="hr-horizontal">
                    <h5 class="mt-4 mb-3">Estilo de barra de navegación</h5>
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class="btn btn-border d-block" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                            <span class="mt-2">Vidrio</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="navbar"data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                            <span class="mt-2">Color</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                            <span class="mt-2">Estatico</span>
                        </div>
                        <div class="btn btn-border d-block" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">

                ...
                <div class="row">
                    @if ($materias->count() > 0)
                        @foreach ($materias as $item)
                            @php
                                $programacion = $estudiante->programados->firstWhere('cursoDocente.materia_id', $item->id);
                            ...
                            <div class="col-lg-4 col-md-12">
                                <a class="card" 
                                    ...
                                    @endif>
                                    <div class="card-body rounded-4" style="{{ $estado == 'No programado' ?: 'background: #ffd1ab'}}">

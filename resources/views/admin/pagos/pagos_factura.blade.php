                                    ...
                                    <tr>
                                        <td bgcolor="white" valign="top">
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                            <tbody>
                                                            <tr>
                                                                <td align="center" style="padding-top:60px;padding-bottom:50px;border-bottom:1px solid #EBEBEB;" valign="top">
                                                                    <span style="font-family:Zent, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:200%;font-weight:bold;">
                                            ...
                                            <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tbody>
                                                <tr>
                                                    <td style="padding-left:50px;padding-right:50px; padding-top: 30px; padding-bottom: 30px; font-size:100%;" align="center" valign="top">
                                                        <table align="center" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                            <tbody>
                                                            <tr>
                                                                <td style="font-family:Zent, 'Helvetica Neue', Helvetica, Arial, sans-serif;padding-bottom:10px; font-size: 120%;  font-weight: bold;" align="left" valign="top">Total
                                                                </td>
                                                                <td style="font-family:Zent, 'Helvetica Neue', Helvetica, Arial, sans-serif;padding-bottom:10px; font-size: 120%; font-weight: bold;" align="right" valign="top">
                                                                    {{ $pago->monto }}Bs.
                                                                </td>
                                                            </tr>
                                                            </tbody>

                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="text-center">
                            <button id="seleccionarTodo" class="btn btn-outline-success"><i
                                    class="bi bi-check-all"></i></button>
                            <button id="deseleccionarTodo" class="btn btn-outline-danger"><i
                        ...
                        @else
                        <div class="text-center">
                            No hay estudiantes que programar
                        </div>
                        @endif
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <input class="form-check-input seleccionar" type="checkbox" name="estudiante[]"
                                            value="{{ $item->id }}">
                                    </td>
                                    <td><a href="{{ route('admin.E.show', $item->persona->id) }}">{{
                                            $item->persona->nombre }} {{ $item->persona->ap_paterno }} {{
                                            $item->persona->ap_materno }}</a></td>
                                    <td class="text-center">
                                        <p>{{ $item->persona->ci }}</p>
                                    </td>
                                    <td class="text-center">{{ $item->turnos->turno }}</p>
                                    </td>
                                    <td class="text-center">
